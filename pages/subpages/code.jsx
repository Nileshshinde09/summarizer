...
summer=summerize(threeidiots)
    ...
    useEffect(() => {
        ...
        clipboard.on('success', function (e) {
          // Show a tooltip or a message to indicate successful copy
  ...
  return (
    <>
    <h1 className='mt-5  text-2xl text-center font-semibold w-[20rem] mx-auto'>Code of ml model.....</h1>
    <div className='no-scrollbar mx-auto mt-2 h-[35rem] overflow-scroll rounded-xl border-violet-600 p-5 border-4 w-3/4 bg-slate-300'>
      <pre>
        <code className='text-xl'>{codeSnippet}</code>
      </pre>
    </div>
    <div className='mx-auto flex justify-center mt-3'>

      <button
          className='copy-button mx-auto  bg-blue-500 text-white p-2 rounded cursor-pointer'
          data-clipboard-text={codeSnippet}
          >
          Copy Code
        </button>
            </div>
